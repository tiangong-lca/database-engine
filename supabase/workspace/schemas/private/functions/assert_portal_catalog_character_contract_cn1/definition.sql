CREATE OR REPLACE FUNCTION "private"."assert_portal_catalog_character_contract_cn1"() RETURNS "void"
...
GRANT ALL ON FUNCTION "private"."assert_portal_catalog_character_contract_cn1"() TO "api_internal_executor";
