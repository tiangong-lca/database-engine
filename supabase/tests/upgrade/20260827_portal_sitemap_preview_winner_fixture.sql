-- Issue #539 recovery-only fixture. These are the exact two sitemap
-- migrations recorded by the first PR Preview head (343b7a1). Apply only after
-- resetting an explicitly isolated project to 20260827134100, then mark both
-- versions applied and exercise the checked-in 20260827134103 forward repair.
-- Never place this fixture under supabase/migrations or run it on a hosted DB.
