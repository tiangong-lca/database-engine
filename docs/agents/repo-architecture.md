...
lastReviewedNote: "Documented database ownership for sealed Step 3 flow-identity execution, terminal closure, and zero-write scope cancellation."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
