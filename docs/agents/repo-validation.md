...
lastReviewedNote: "Reviewed for Issue #377 after syncing Issue #376/#323 integration: the early conditional fault-injection fixture and complete canonical suite use the existing flow-identity proof matrix."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
