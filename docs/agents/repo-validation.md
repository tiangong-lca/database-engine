...
lastReviewedNote: "Reviewed for Issue #324 Flow derivative fence narrowing: add focused busy-actor derivative-fence proof while retaining the complete Step 3 identity and derivative rebuild regression suites."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
