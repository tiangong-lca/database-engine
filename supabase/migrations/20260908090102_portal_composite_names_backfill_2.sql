...
do $bound$ begin
  if (select count(*) from (select 1 from public.processes source where source.id >= '80000000-0000-0000-0000-000000000000'::uuid and source.id < 'c0000000-0000-0000-0000-000000000000'::uuid and source.state_code in (100,200) and source.modified_at is not null and jsonb_typeof(source.json) = 'object' and jsonb_typeof(source.json -> 'processDataSet') = 'object' limit 5001) bounded) > 5000 then
...
with source_rows as materialized (
  ...
  from public.processes source where source.id >= '80000000-0000-0000-0000-000000000000'::uuid and source.id < 'c0000000-0000-0000-0000-000000000000'::uuid and source.state_code in (100,200) and source.modified_at is not null and jsonb_typeof(source.json) = 'object' and jsonb_typeof(source.json -> 'processDataSet') = 'object'
...
select 2,count(*) from private.portal_catalog_search_rows_v2 source where source.id >= '80000000-0000-0000-0000-000000000000'::uuid and source.id < 'c0000000-0000-0000-0000-000000000000'::uuid
