...
lastReviewedNote: "Reviewed Issue #308 rollout compatibility: the owner read projection is locator-free, strict public downloads retain two selectors, and the temporary one-argument XLSX overload remains until Edge migration cleanup."
related:
  - .docpact/config.yaml
