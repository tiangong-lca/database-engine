...
lastReviewedNote: "Reviewed Issue #308 rollout compatibility: Database owns the locator-free owner artifact summary, strict selector DTO, temporary XLSX overload, and reclaimable post-tombstone detail cleanup; Worker owns object deletion."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
