...
if [[ "${#repo_migrations[@]}" -ne 277 \
   || "${#test_migrations[@]}" -ne 277 ]]; then
  echo "complete migration tree must contain exactly 277 files" >&2
  exit 2
fi
...
echo "Migration tree SHA-256 (277 files): $migration_tree_sha256"
