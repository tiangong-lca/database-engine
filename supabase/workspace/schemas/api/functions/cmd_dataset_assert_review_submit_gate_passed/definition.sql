CREATE OR REPLACE FUNCTION "api"."cmd_dataset_assert_review_submit_gate_passed"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_gate_run_id" "uuid" DEFAULT NULL::"uuid", "p_revision_checksum" "text" DEFAULT NULL::"text", "p_policy_profile" "text" DEFAULT 'review_submit_fast.v1'::"text", "p_report_schema_version" "text" DEFAULT 'review_submit_gate_report.v1'::"text") RETURNS "jsonb"
...
begin
  ...
  v_payload := private.cmd_dataset_review_submit_gate_payload(v_run);
  ...
  if v_run.revision_checksum <> p_revision_checksum then
    return jsonb_build_object(
      ...
      'details', private.cmd_dataset_review_submit_gate_payload(v_run, 'stale')
    );
  end if;
...
ALTER FUNCTION "api"."cmd_dataset_assert_review_submit_gate_passed"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_gate_run_id" "uuid", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "api"."cmd_dataset_assert_review_submit_gate_passed"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_gate_run_id" "uuid", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "api"."cmd_dataset_assert_review_submit_gate_passed"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_gate_run_id" "uuid", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text") TO "api_internal_executor";
