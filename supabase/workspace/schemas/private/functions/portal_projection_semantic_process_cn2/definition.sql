CREATE OR REPLACE FUNCTION "private"."portal_projection_semantic_process_cn2"("p_query_embedding" "extensions"."vector", "p_filters" "jsonb") RETURNS TABLE("id" "uuid", "version" "text", "semantic_distance" double precision)
...
ALTER FUNCTION "private"."portal_projection_semantic_process_cn2"("p_query_embedding" "extensions"."vector", "p_filters" "jsonb") OWNER TO "portal_public_executor";

REVOKE ALL ON FUNCTION "private"."portal_projection_semantic_process_cn2"("p_query_embedding" "extensions"."vector", "p_filters" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."portal_projection_semantic_process_cn2"("p_query_embedding" "extensions"."vector", "p_filters" "jsonb") TO "api_internal_executor";
