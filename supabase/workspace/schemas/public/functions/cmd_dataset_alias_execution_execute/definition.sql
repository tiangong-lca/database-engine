CREATE OR REPLACE FUNCTION "public"."cmd_dataset_alias_execution_execute"("p_request_id" "uuid", "p_nonce" "text") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_dataset_alias_execution_execute"("p_request_id" "uuid", "p_nonce" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_dataset_alias_execution_execute"("p_request_id" "uuid", "p_nonce" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_dataset_alias_execution_execute"("p_request_id" "uuid", "p_nonce" "text") TO "service_role";
