...
lastReviewedNote: "Reviewed for Issue #563: bounded Process keyword ranking remains inside the existing Portal projection/public-contract boundary and adds no new repository ownership or deployment path."
related:
  - .docpact/config.yaml
