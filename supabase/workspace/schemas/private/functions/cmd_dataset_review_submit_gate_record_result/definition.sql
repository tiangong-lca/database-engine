...
begin
  ...
  update private.dataset_review_submit_gate_runs
    set status = v_status,
...
ALTER FUNCTION "private"."cmd_dataset_review_submit_gate_record_result"("p_gate_run_id" "uuid", "p_status" "text", "p_calculator_report" "jsonb", "p_blocking_reasons" "jsonb", "p_report_schema_version" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "private"."cmd_dataset_review_submit_gate_record_result"("p_gate_run_id" "uuid", "p_status" "text", "p_calculator_report" "jsonb", "p_blocking_reasons" "jsonb", "p_report_schema_version" "text", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."cmd_dataset_review_submit_gate_record_result"("p_gate_run_id" "uuid", "p_status" "text", "p_calculator_report" "jsonb", "p_blocking_reasons" "jsonb", "p_report_schema_version" "text", "p_audit" "jsonb") TO "service_role";

GRANT ALL ON FUNCTION "private"."cmd_dataset_review_submit_gate_record_result"("p_gate_run_id" "uuid", "p_status" "text", "p_calculator_report" "jsonb", "p_blocking_reasons" "jsonb", "p_report_schema_version" "text", "p_audit" "jsonb") TO "api_internal_executor";
