...
lastReviewedNote: "Updated for Issue #446: review validation now proves current JSON/comment derivation and absence of persisted Root/Reference mappings; blank reset, focused pgTAP, exact-local regeneration, and CI remain required."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
