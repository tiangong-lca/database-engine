...
lastReviewedNote: "Reviewed issue #287; first-release scope-closure changes require zero-release candidate, release-bound, task/ACL contract, reset, migration-list, and advisor proof."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
