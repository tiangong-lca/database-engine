...
lastReviewedNote: "Reviewed for Issue #390: adds the non-authorizing physical qualification scaffold, exact baseline receipt surface, and fail-closed future execution gate."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
