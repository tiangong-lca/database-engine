...
lastReviewedNote: 'Reviewed for Database #620: Process and Flow V2 selective-filter routing, fixed Portal execution, ACL/RLS boundaries, and natural broad-plan evidence now share one validation contract.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
