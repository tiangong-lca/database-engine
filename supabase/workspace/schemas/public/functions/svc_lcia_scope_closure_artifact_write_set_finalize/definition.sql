CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_finalize"("p_write_set_id" "uuid", "p_write_token" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_finalize"("p_write_set_id" "uuid", "p_write_token" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_finalize"("p_write_set_id" "uuid", "p_write_token" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_finalize"("p_write_set_id" "uuid", "p_write_token" "uuid") TO "service_role";
