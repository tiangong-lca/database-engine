...
lastReviewedNote: "Reviewed Issue #308 authoritative artifact delivery: base-to-head upgrade, fresh/reused DB-first staging, atomic manifest resolution, non-mutating preview, renewable GC fencing, public DTOs, and advisor proof are explicit."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
