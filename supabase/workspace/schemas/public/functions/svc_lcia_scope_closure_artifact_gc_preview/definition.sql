CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_preview"("p_limit" integer DEFAULT 100) RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_preview"("p_limit" integer) OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_preview"("p_limit" integer) FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_preview"("p_limit" integer) TO "service_role";
