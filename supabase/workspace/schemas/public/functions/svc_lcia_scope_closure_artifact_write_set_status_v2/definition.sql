CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_status_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_status_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_status_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_status_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid") TO "service_role";
