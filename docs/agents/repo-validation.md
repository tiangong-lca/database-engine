...
lastReviewedNote: "Reviewed strict Step 3 wrapper/recovery and disposable Hosted Preview proof together with the LCI/LCIA release-control validation now present on dev."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
