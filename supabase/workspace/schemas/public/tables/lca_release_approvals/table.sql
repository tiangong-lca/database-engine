...
ALTER TABLE "public"."lca_release_approvals" OWNER TO "postgres";

COMMENT ON TABLE "public"."lca_release_approvals" IS 'Durable human approval receipts bound to an exact immutable publish-plan hash.';

ALTER TABLE ONLY "public"."lca_release_approvals"
    ADD CONSTRAINT "lca_release_approvals_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."lca_release_approvals"
    ADD CONSTRAINT "lca_release_approvals_release_run_id_fkey" FOREIGN KEY ("release_run_id") REFERENCES "public"."lca_release_runs"("id") ON DELETE RESTRICT;
