CREATE OR REPLACE FUNCTION "public"."flows_derivative_rebuild_embedding_input"("p_flow" "public"."flows") RETURNS "text"
...
ALTER FUNCTION "public"."flows_derivative_rebuild_embedding_input"("p_flow" "public"."flows") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."flows_derivative_rebuild_embedding_input"("p_flow" "public"."flows") FROM PUBLIC;
