...
lastReviewedNote: "Reviewed Issue #297 foundation embedding queue selector: local selector/backpressure regression plus persistent-dev real-queue plan and unchanged-policy proof requirements are explicit."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
