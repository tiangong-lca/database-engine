CREATE OR REPLACE FUNCTION "public"."cmd_lcia_scope_closure_check_request_v2_untracked"("p_requested_scope" "jsonb", "p_request_idempotency_token" "text", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_lcia_scope_closure_check_request_v2_untracked"("p_requested_scope" "jsonb", "p_request_idempotency_token" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_lcia_scope_closure_check_request_v2_untracked"("p_requested_scope" "jsonb", "p_request_idempotency_token" "text", "p_audit" "jsonb") FROM PUBLIC;
