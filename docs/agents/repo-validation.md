...
lastReviewedNote: "Reviewed Issues #291 and #292 together: index-health prefix assertions, hooks maintenance-window proof, and measured hybrid-search EXPLAIN, pgTAP, migration-history, lint, and advisor requirements are all retained."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
