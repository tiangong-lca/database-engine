...
if [[ "${#repo_migrations[@]}" -ne 289 \
   || "${#test_migrations[@]}" -ne 289 ]]; then
  echo "complete migration tree must contain exactly 289 files" >&2
  exit 2
fi
...
echo "Migration tree SHA-256 (289 files): $migration_tree_sha256"
