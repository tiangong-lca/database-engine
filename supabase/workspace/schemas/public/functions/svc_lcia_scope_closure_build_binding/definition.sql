CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_build_binding"("build_worker_job_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_build_binding"("build_worker_job_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_build_binding"("build_worker_job_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_build_binding"("build_worker_job_id" "uuid") TO "service_role";
