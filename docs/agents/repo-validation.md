...
lastReviewedNote: "Added proof requirements for durable Step 3 rewrites, dynamic derivative closure, and zero-write-only scope cancellation."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
