CREATE OR REPLACE FUNCTION "private"."catalog_portal_process_pattern_versions_cn1"("p_like_pattern" "text") RETURNS TABLE("id" "uuid", "version" "text")
...
ALTER FUNCTION "private"."catalog_portal_process_pattern_versions_cn1"("p_like_pattern" "text") OWNER TO "portal_public_executor";

REVOKE ALL ON FUNCTION "private"."catalog_portal_process_pattern_versions_cn1"("p_like_pattern" "text") FROM PUBLIC;
