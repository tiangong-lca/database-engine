CREATE OR REPLACE FUNCTION "public"."cmd_lcia_result_package_publish"("p_package_id" "uuid", "p_display_default_impact_category" "text" DEFAULT NULL::"text", "p_reason" "text" DEFAULT NULL::"text", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_lcia_result_package_publish"("p_package_id" "uuid", "p_display_default_impact_category" "text", "p_reason" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_lcia_result_package_publish"("p_package_id" "uuid", "p_display_default_impact_category" "text", "p_reason" "text", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_lcia_result_package_publish"("p_package_id" "uuid", "p_display_default_impact_category" "text", "p_reason" "text", "p_audit" "jsonb") TO "anon";

GRANT ALL ON FUNCTION "public"."cmd_lcia_result_package_publish"("p_package_id" "uuid", "p_display_default_impact_category" "text", "p_reason" "text", "p_audit" "jsonb") TO "authenticated";

GRANT ALL ON FUNCTION "public"."cmd_lcia_result_package_publish"("p_package_id" "uuid", "p_display_default_impact_category" "text", "p_reason" "text", "p_audit" "jsonb") TO "service_role";
