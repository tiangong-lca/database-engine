...
lastReviewedNote: "Reviewed issue #292 for measured process/flow hybrid-search tuning; added read-only staging EXPLAIN proof, focused pgTAP, reset, migration-history, lint, and advisor requirements."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
