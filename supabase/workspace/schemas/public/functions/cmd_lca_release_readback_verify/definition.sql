CREATE OR REPLACE FUNCTION "public"."cmd_lca_release_readback_verify"("p_release_run_id" "uuid", "p_release_manifest_hash" "text", "p_artifact_hashes" "jsonb", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_lca_release_readback_verify"("p_release_run_id" "uuid", "p_release_manifest_hash" "text", "p_artifact_hashes" "jsonb", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_lca_release_readback_verify"("p_release_run_id" "uuid", "p_release_manifest_hash" "text", "p_artifact_hashes" "jsonb", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_lca_release_readback_verify"("p_release_run_id" "uuid", "p_release_manifest_hash" "text", "p_artifact_hashes" "jsonb", "p_audit" "jsonb") TO "authenticated";
