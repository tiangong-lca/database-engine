CREATE OR REPLACE VIEW "util"."worker_legacy_lifecycle_audit" WITH ("security_invoker"='true') AS
...
ALTER VIEW "util"."worker_legacy_lifecycle_audit" OWNER TO "postgres";
