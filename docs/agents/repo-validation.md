...
lastReviewedNote: "Added proof requirements for strict Step 3 wrapper invocation, rotating permits, exact lookup, and fresh approved recovery."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
