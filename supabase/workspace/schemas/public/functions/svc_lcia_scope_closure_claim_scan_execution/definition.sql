CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_claim_scan_execution"("p_scan_execution_id" "uuid", "p_worker_job_id" "uuid", "p_lease_token" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_claim_scan_execution"("p_scan_execution_id" "uuid", "p_worker_job_id" "uuid", "p_lease_token" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_claim_scan_execution"("p_scan_execution_id" "uuid", "p_worker_job_id" "uuid", "p_lease_token" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_claim_scan_execution"("p_scan_execution_id" "uuid", "p_worker_job_id" "uuid", "p_lease_token" "uuid") TO "service_role";
