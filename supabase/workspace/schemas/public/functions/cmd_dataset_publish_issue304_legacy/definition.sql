CREATE OR REPLACE FUNCTION "public"."cmd_dataset_publish_issue304_legacy"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_dataset_publish_issue304_legacy"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_dataset_publish_issue304_legacy"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_audit" "jsonb") FROM PUBLIC;
