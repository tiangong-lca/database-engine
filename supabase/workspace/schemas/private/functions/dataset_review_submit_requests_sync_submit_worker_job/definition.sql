CREATE OR REPLACE FUNCTION "private"."dataset_review_submit_requests_sync_submit_worker_job"() RETURNS "trigger"
...
ALTER FUNCTION "private"."dataset_review_submit_requests_sync_submit_worker_job"() OWNER TO "postgres";

REVOKE ALL ON FUNCTION "private"."dataset_review_submit_requests_sync_submit_worker_job"() FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."dataset_review_submit_requests_sync_submit_worker_job"() TO "service_role";

GRANT ALL ON FUNCTION "private"."dataset_review_submit_requests_sync_submit_worker_job"() TO "api_internal_executor";
