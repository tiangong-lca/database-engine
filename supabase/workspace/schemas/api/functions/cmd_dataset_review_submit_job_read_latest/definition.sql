CREATE OR REPLACE FUNCTION "api"."cmd_dataset_review_submit_job_read_latest"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text" DEFAULT NULL::"text") RETURNS "jsonb"
...
ALTER FUNCTION "api"."cmd_dataset_review_submit_job_read_latest"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_read_latest"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_read_latest"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text") TO "api_internal_executor";

GRANT ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_read_latest"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text") TO "authenticated";
