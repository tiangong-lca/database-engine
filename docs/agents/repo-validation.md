...
lastReviewedNote: "Updated for Issue #450: Scope Closure proof now includes blocked shared-scan reuse without a numerical snapshot and scanner-revision cache invalidation."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
