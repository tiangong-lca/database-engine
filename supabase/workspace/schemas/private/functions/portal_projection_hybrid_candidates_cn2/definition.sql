CREATE OR REPLACE FUNCTION "private"."portal_projection_hybrid_candidates_cn2"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb") RETURNS TABLE("id" "uuid", "version" "text", "lexical_rank" integer, "semantic_rank" integer, "semantic_distance" double precision, "score" numeric)
...
ALTER FUNCTION "private"."portal_projection_hybrid_candidates_cn2"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb") OWNER TO "api_internal_executor";

REVOKE ALL ON FUNCTION "private"."portal_projection_hybrid_candidates_cn2"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."portal_projection_hybrid_candidates_cn2"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb") TO "portal_public_executor";
