CREATE OR REPLACE FUNCTION "public"."cmd_dataset_withdraw"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_reason" "text", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_dataset_withdraw"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_reason" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_dataset_withdraw"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_reason" "text", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_dataset_withdraw"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_reason" "text", "p_audit" "jsonb") TO "authenticated";

GRANT ALL ON FUNCTION "public"."cmd_dataset_withdraw"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_reason" "text", "p_audit" "jsonb") TO "service_role";
