CREATE OR REPLACE FUNCTION "public"."cmd_dataset_semantic_backfill"("p_table" "text", "p_batch_size" integer DEFAULT 100, "p_after_id" "uuid" DEFAULT NULL::"uuid", "p_after_version" "text" DEFAULT NULL::"text", "p_force_extraction" boolean DEFAULT false) RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_dataset_semantic_backfill"("p_table" "text", "p_batch_size" integer, "p_after_id" "uuid", "p_after_version" "text", "p_force_extraction" boolean) OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_dataset_semantic_backfill"("p_table" "text", "p_batch_size" integer, "p_after_id" "uuid", "p_after_version" "text", "p_force_extraction" boolean) FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_dataset_semantic_backfill"("p_table" "text", "p_batch_size" integer, "p_after_id" "uuid", "p_after_version" "text", "p_force_extraction" boolean) TO "service_role";
