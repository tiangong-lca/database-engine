CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid", "p_contract_version" "text", "p_expected_descriptor_count" integer, "p_descriptor_set_sha256" "text", "p_required_primary_roles" "jsonb", "p_staging_seconds" integer DEFAULT 900, "p_reused_from_check_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid", "p_contract_version" "text", "p_expected_descriptor_count" integer, "p_descriptor_set_sha256" "text", "p_required_primary_roles" "jsonb", "p_staging_seconds" integer, "p_reused_from_check_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid", "p_contract_version" "text", "p_expected_descriptor_count" integer, "p_descriptor_set_sha256" "text", "p_required_primary_roles" "jsonb", "p_staging_seconds" integer, "p_reused_from_check_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create_v2"("p_closure_check_id" "uuid", "p_worker_job_id" "uuid", "p_worker_lease_token" "uuid", "p_request_id" "uuid", "p_contract_version" "text", "p_expected_descriptor_count" integer, "p_descriptor_set_sha256" "text", "p_required_primary_roles" "jsonb", "p_staging_seconds" integer, "p_reused_from_check_id" "uuid") TO "service_role";
