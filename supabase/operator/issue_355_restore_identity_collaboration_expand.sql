...
drop function private.review_append_scope_snapshot_v1(uuid,text,text,jsonb,uuid);
drop function private.review_revision_fingerprint_v1(text,jsonb);
drop function private.review_scope_all_reference_ids_v1(jsonb);
drop function private.review_scope_checksum_v1(jsonb);
drop function private.review_scope_current_items_v1(jsonb);
drop function private.review_scope_current_reference_ids_v1(jsonb);
drop function private.review_scope_current_snapshot_v1(jsonb);
drop function private.review_validate_scope_history_v1(uuid,jsonb);
