CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create"("p_closure_check_id" "uuid", "p_idempotency_key" "text", "p_items" "jsonb", "p_staging_seconds" integer DEFAULT 900, "p_reused_from_check_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create"("p_closure_check_id" "uuid", "p_idempotency_key" "text", "p_items" "jsonb", "p_staging_seconds" integer, "p_reused_from_check_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create"("p_closure_check_id" "uuid", "p_idempotency_key" "text", "p_items" "jsonb", "p_staging_seconds" integer, "p_reused_from_check_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_write_set_create"("p_closure_check_id" "uuid", "p_idempotency_key" "text", "p_items" "jsonb", "p_staging_seconds" integer, "p_reused_from_check_id" "uuid") TO "service_role";
