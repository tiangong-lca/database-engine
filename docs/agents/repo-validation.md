...
lastReviewedNote: "Reviewed Issue #297 foundation-dataset Semantic/Hybrid visibility parity: local state/team regression, cursor backfill, queue-drain, Hosted plan, and advisor proof requirements are explicit."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
