CREATE OR REPLACE FUNCTION "api"."cmd_dataset_review_submit_job_read"("p_job_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "api"."cmd_dataset_review_submit_job_read"("p_job_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_read"("p_job_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_read"("p_job_id" "uuid") TO "api_internal_executor";

GRANT ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_read"("p_job_id" "uuid") TO "authenticated";
