CREATE OR REPLACE FUNCTION "public"."svc_lcia_document_validation_evidence_lookup"("p_cache_keys" "jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_document_validation_evidence_lookup"("p_cache_keys" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_document_validation_evidence_lookup"("p_cache_keys" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_document_validation_evidence_lookup"("p_cache_keys" "jsonb") TO "service_role";
