CREATE OR REPLACE FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid") OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid", "p_artifact_role" "text") RETURNS "jsonb"
...
ALTER FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid", "p_artifact_role" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid") TO "authenticated";

REVOKE ALL ON FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid", "p_artifact_role" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."get_lcia_scope_closure_report_download"("p_closure_check_id" "uuid", "p_artifact_role" "text") TO "authenticated";
