...
lastReviewedNote: "Reviewed for Issue #418: the remaining example and guarded benchmark refs now target the recreated persistent dev; the validation matrix itself is unchanged."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
