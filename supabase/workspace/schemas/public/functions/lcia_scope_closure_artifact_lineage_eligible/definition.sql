CREATE OR REPLACE FUNCTION "public"."lcia_scope_closure_artifact_lineage_eligible"("p_check" "public"."lcia_scope_closure_checks", "p_artifact" "public"."worker_job_artifacts", "p_public_artifact_role" "text") RETURNS boolean
...
ALTER FUNCTION "public"."lcia_scope_closure_artifact_lineage_eligible"("p_check" "public"."lcia_scope_closure_checks", "p_artifact" "public"."worker_job_artifacts", "p_public_artifact_role" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lcia_scope_closure_artifact_lineage_eligible"("p_check" "public"."lcia_scope_closure_checks", "p_artifact" "public"."worker_job_artifacts", "p_public_artifact_role" "text") FROM PUBLIC;
