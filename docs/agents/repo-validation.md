...
lastReviewedNote: "Reviewed for Issue #405: exact-head inventory proof separates offline hash replay from explicit loopback catalog regeneration and keeps Contract blocked."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
