...
lastReviewedNote: "Reviewed for Issue #422 contract closure: schema inspection output and the public/api TypeScript Data API contract now have explicit generation and drift rules."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ../../docs/agents/repo-architecture.md
...
`database.types.ts` is generated separately by `python scripts/build_database_types.py` and covers only the exposed `public` and `api` schemas.
