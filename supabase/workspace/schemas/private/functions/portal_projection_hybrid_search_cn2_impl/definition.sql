CREATE OR REPLACE FUNCTION "private"."portal_projection_hybrid_search_cn2_impl"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb", "p_limit" integer, "p_query_fingerprint" "text", "p_cursor" "jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "private"."portal_projection_hybrid_search_cn2_impl"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb", "p_limit" integer, "p_query_fingerprint" "text", "p_cursor" "jsonb") OWNER TO "api_internal_executor";

REVOKE ALL ON FUNCTION "private"."portal_projection_hybrid_search_cn2_impl"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb", "p_limit" integer, "p_query_fingerprint" "text", "p_cursor" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."portal_projection_hybrid_search_cn2_impl"("p_kind" "text", "p_query_terms" "text"[], "p_query_embedding" "extensions"."vector", "p_filters" "jsonb", "p_limit" integer, "p_query_fingerprint" "text", "p_cursor" "jsonb") TO "portal_public_executor";
