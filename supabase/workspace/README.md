...
lastReviewedNote: "Reviewed through the Issue #354 hosted repair and for #333: guarded blank-to-head generation preserves byte-identical five-schema output while SECURITY DEFINER audit evidence remains in the stable test-contract surface."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ../../docs/agents/repo-architecture.md
...
- Do not place SECURITY DEFINER owner/runtime decisions here. Their stable audited ledger is `supabase/tests/contracts/security_definer_audit.*`, regenerated by `scripts/security_definer_audit.py`.
