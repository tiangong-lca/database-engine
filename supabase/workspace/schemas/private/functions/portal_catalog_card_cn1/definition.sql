CREATE OR REPLACE FUNCTION "private"."portal_catalog_card_cn1"("p_kind" "text", "p_state_code" integer, "p_json" "jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "private"."portal_catalog_card_cn1"("p_kind" "text", "p_state_code" integer, "p_json" "jsonb") OWNER TO "portal_public_executor";

REVOKE ALL ON FUNCTION "private"."portal_catalog_card_cn1"("p_kind" "text", "p_state_code" integer, "p_json" "jsonb") FROM PUBLIC;
