...
lastReviewedNote: "Reviewed for Issue #414: snapshot GC audit physical Expand adds a dedicated populated/lock/concurrency/role/Data-API/rollback qualification and advances exact-head inventory to 20260804123000 while keeping Contract blocked."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
