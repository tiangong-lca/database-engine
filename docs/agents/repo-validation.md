...
lastReviewedNote: "Reviewed through Issues #339/#341, #346, and #351: retain opaque-key Worker qualification, ACL-aware rehearsal, fresh million-row CLI roll-forward, new-only evidence, URL redaction, zero-WAL retry, and persistent-dev rollback/readback proof."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
