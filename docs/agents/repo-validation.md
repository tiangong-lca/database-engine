...
lastReviewedNote: "Updated for Issue #459: Database A search_text expansion is nullable and additive, canonical Search RPCs retain compatibility wrappers, lexical reads remain on extracted_md, and Database B/C/D are deferred; local reset, exact API closure, and generated-type drift checks are required."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
