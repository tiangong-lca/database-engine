...
lastReviewedNote: "Updated for Issue #459: Database A search_text expansion is nullable and additive, canonical Search RPCs retain compatibility wrappers, lexical reads remain on extracted_md, and Database A provides bounded enqueue only. Historical backfill is the workspace#565 Release 1 operational gate after Edge double-write deployment, not migration work; Database B owns index/source switch, Database C old-index cleanup, and Database D old-RPC cleanup."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
