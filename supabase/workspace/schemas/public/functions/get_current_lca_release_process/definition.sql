CREATE OR REPLACE FUNCTION "public"."get_current_lca_release_process"("p_process_uuid" "uuid", "p_process_version" "text") RETURNS "jsonb"
...
ALTER FUNCTION "public"."get_current_lca_release_process"("p_process_uuid" "uuid", "p_process_version" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."get_current_lca_release_process"("p_process_uuid" "uuid", "p_process_version" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."get_current_lca_release_process"("p_process_uuid" "uuid", "p_process_version" "text") TO "anon";

GRANT ALL ON FUNCTION "public"."get_current_lca_release_process"("p_process_uuid" "uuid", "p_process_version" "text") TO "authenticated";

GRANT ALL ON FUNCTION "public"."get_current_lca_release_process"("p_process_uuid" "uuid", "p_process_version" "text") TO "service_role";
