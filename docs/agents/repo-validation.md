...
lastReviewedNote: "Reviewed Issue #304 review/publication lifecycle closure: path roles, composition-source agreement, atomic zero-write failures, safe errors, and required-support regression proof are explicit."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
