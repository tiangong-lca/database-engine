...
lastReviewedNote: "Reviewed Issue #297 foundation-dataset Semantic/Hybrid parity: local regression, cursor backfill, queue-drain, Hosted plan, and advisor proof requirements are explicit."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
