...
- Do not place pre-DDL consumer-cut authorization evidence here. Stable `*_pre_ddl.v1.json` contracts live under `supabase/tests/contracts/`; they fail closed until static, runtime, and owner gates permit a reviewed migration.
