...
do $verify_portal_facet_backfill_c0_ff_process_count$
begin
  if (
    select count(*)
    from private.portal_catalog_search_rows_v1 as projection
...
$verify_portal_facet_backfill_c0_ff_process_count$;

do $verify_portal_facet_backfill_c0_ff_flow_count$
begin
  if (
    select count(*)
    from private.portal_catalog_search_rows_v1 as projection
...
$verify_portal_facet_backfill_c0_ff_flow_count$;
