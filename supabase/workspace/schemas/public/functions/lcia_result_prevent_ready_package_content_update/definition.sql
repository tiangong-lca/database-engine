CREATE OR REPLACE FUNCTION "public"."lcia_result_prevent_ready_package_content_update"() RETURNS "trigger"
    LANGUAGE "plpgsql"
...
ALTER FUNCTION "public"."lcia_result_prevent_ready_package_content_update"() OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lcia_result_prevent_ready_package_content_update"() FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."lcia_result_prevent_ready_package_content_update"() TO "anon";

GRANT ALL ON FUNCTION "public"."lcia_result_prevent_ready_package_content_update"() TO "authenticated";

GRANT ALL ON FUNCTION "public"."lcia_result_prevent_ready_package_content_update"() TO "service_role";
