...
drop function api.search_processes(text, jsonb, integer, integer, text, text, uuid, integer, text, text[], boolean);
...
comment on function api.search_processes(text, jsonb, integer, integer, text, text, uuid, integer, text, text[], boolean) is
  'Canonical Process lexical search RPC. Delegates to the reviewed private implementation and returns model_version from the selected Process revision.';
