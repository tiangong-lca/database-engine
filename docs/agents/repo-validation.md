...
lastReviewedNote: "Reviewed protected-runner hosted Preview proof: exact-ref fixtures, real authenticated REST transport faults, actor-scoped cleanup, and rollback-only database timeout injection are required before release."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
