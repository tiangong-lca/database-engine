CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_certificate_event"("p_closure_check_id" "uuid", "p_certificate_status" "text", "p_reason" "text") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_certificate_event"("p_closure_check_id" "uuid", "p_certificate_status" "text", "p_reason" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_certificate_event"("p_closure_check_id" "uuid", "p_certificate_status" "text", "p_reason" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_certificate_event"("p_closure_check_id" "uuid", "p_certificate_status" "text", "p_reason" "text") TO "service_role";
