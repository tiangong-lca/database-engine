...
lastReviewedNote: "Reviewed for Issue #582: direct OAuth proof remains exact; workflow proof accepts official Preview skip only when deployable Supabase inputs are unchanged."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
