...
lastReviewedNote: "Reviewed after adding exact immediate and reclaimed-Worker Portal LCIA package-ready recovery; repository shape and ownership are unchanged."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
