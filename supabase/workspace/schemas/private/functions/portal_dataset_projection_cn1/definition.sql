CREATE OR REPLACE FUNCTION "private"."portal_dataset_projection_cn1"("p_kind" "text", "p_id" "uuid", "p_version" "text") RETURNS "jsonb"
...
ALTER FUNCTION "private"."portal_dataset_projection_cn1"("p_kind" "text", "p_id" "uuid", "p_version" "text") OWNER TO "portal_public_executor";

REVOKE ALL ON FUNCTION "private"."portal_dataset_projection_cn1"("p_kind" "text", "p_id" "uuid", "p_version" "text") FROM PUBLIC;
