...
ALTER FUNCTION "public"."svc_lcia_scope_closure_check_record_result"("p_closure_check_id" "uuid", "p_status" "text", "p_scan_completeness" "text", "p_effective_scope_hash" "text", "p_certificate_hash" "text", "p_result_summary" "jsonb", "p_blocker_codes" "text"[], "p_report_artifact_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_check_record_result"("p_closure_check_id" "uuid", "p_status" "text", "p_scan_completeness" "text", "p_effective_scope_hash" "text", "p_certificate_hash" "text", "p_result_summary" "jsonb", "p_blocker_codes" "text"[], "p_report_artifact_id" "uuid") FROM PUBLIC;
