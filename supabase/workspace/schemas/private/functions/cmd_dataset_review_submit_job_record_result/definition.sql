...
declare
  ...
  v_gate private.dataset_review_submit_gate_runs%rowtype;
...
ALTER FUNCTION "private"."cmd_dataset_review_submit_job_record_result"("p_job_id" "uuid", "p_status" "text", "p_gate_run_id" "uuid", "p_result" "jsonb", "p_error_code" "text", "p_error_message" "text", "p_error_details" "jsonb", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "private"."cmd_dataset_review_submit_job_record_result"("p_job_id" "uuid", "p_status" "text", "p_gate_run_id" "uuid", "p_result" "jsonb", "p_error_code" "text", "p_error_message" "text", "p_error_details" "jsonb", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."cmd_dataset_review_submit_job_record_result"("p_job_id" "uuid", "p_status" "text", "p_gate_run_id" "uuid", "p_result" "jsonb", "p_error_code" "text", "p_error_message" "text", "p_error_details" "jsonb", "p_audit" "jsonb") TO "service_role";

GRANT ALL ON FUNCTION "private"."cmd_dataset_review_submit_job_record_result"("p_job_id" "uuid", "p_status" "text", "p_gate_run_id" "uuid", "p_result" "jsonb", "p_error_code" "text", "p_error_message" "text", "p_error_details" "jsonb", "p_audit" "jsonb") TO "api_internal_executor";
