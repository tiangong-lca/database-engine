CREATE OR REPLACE FUNCTION "util"."process_embeddings"("batch_size" integer DEFAULT 3, "max_requests" integer DEFAULT 3, "timeout_milliseconds" integer DEFAULT ((5 * 60) * 1000)) RETURNS "void"
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
declare
...
REVOKE ALL ON FUNCTION "util"."process_embeddings"("batch_size" integer, "max_requests" integer, "timeout_milliseconds" integer) FROM PUBLIC;
