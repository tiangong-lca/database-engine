CREATE OR REPLACE FUNCTION "public"."lca_release_guard_run_update"() RETURNS "trigger"
    LANGUAGE "plpgsql"
...
ALTER FUNCTION "public"."lca_release_guard_run_update"() OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lca_release_guard_run_update"() FROM PUBLIC;
