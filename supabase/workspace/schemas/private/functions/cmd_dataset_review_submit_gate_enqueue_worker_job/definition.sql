...
declare
  ...
  v_worker_existing private.worker_jobs%rowtype;
...
begin
  ...
  if v_worker_existing.id is not null then
    return jsonb_build_object(
      'ok', true,
      'data', private.worker_job_payload(v_worker_existing, true),
      'reused', true
    );
  end if;
  ...
  if v_worker_existing.id is not null then
    return jsonb_build_object(
      ...
      'details', private.worker_job_payload(v_worker_existing, false)
    );
  end if;
  ...
  return jsonb_build_object(
    'ok', true,
    'data', private.worker_job_payload(v_worker_job, true),
    'reused', false
  );
end;
$$;

ALTER FUNCTION "private"."cmd_dataset_review_submit_gate_enqueue_worker_job"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_requested_by" "uuid", "p_gate_run_id" "uuid", "p_action" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "private"."cmd_dataset_review_submit_gate_enqueue_worker_job"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_requested_by" "uuid", "p_gate_run_id" "uuid", "p_action" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "private"."cmd_dataset_review_submit_gate_enqueue_worker_job"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_requested_by" "uuid", "p_gate_run_id" "uuid", "p_action" "text") TO "service_role";

GRANT ALL ON FUNCTION "private"."cmd_dataset_review_submit_gate_enqueue_worker_job"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_requested_by" "uuid", "p_gate_run_id" "uuid", "p_action" "text") TO "api_internal_executor";
