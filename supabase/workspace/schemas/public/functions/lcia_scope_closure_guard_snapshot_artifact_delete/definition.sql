CREATE OR REPLACE FUNCTION "public"."lcia_scope_closure_guard_snapshot_artifact_delete"() RETURNS "trigger"
...
ALTER FUNCTION "public"."lcia_scope_closure_guard_snapshot_artifact_delete"() OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lcia_scope_closure_guard_snapshot_artifact_delete"() FROM PUBLIC;
