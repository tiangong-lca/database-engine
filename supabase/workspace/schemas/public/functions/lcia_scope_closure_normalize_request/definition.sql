CREATE OR REPLACE FUNCTION "public"."lcia_scope_closure_normalize_request"("p_requested_scope" "jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."lcia_scope_closure_normalize_request"("p_requested_scope" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lcia_scope_closure_normalize_request"("p_requested_scope" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."lcia_scope_closure_normalize_request"("p_requested_scope" "jsonb") TO "service_role";
