...
lastReviewedNote: "Reviewed for Issue #566: OAuth client admission requires a private revocation registry, relation-read and actor-command grants, restrictive read RLS, a complete PostgREST manifest gate, and transport-level revocation proof."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
