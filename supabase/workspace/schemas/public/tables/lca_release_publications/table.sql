...
ALTER TABLE "public"."lca_release_publications" OWNER TO "postgres";

COMMENT ON TABLE "public"."lca_release_publications" IS 'Public release facts with distinct approved_by and executed_by audit identities.';

ALTER TABLE ONLY "public"."lca_release_publications"
...
ALTER TABLE ONLY "public"."lca_release_publications"
    ADD CONSTRAINT "lca_release_publications_approval_id_fkey" FOREIGN KEY ("approval_id") REFERENCES "public"."lca_release_approvals"("id") ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."lca_release_publications"
    ADD CONSTRAINT "lca_release_publications_release_run_id_fkey" FOREIGN KEY ("release_run_id") REFERENCES "public"."lca_release_runs"("id") ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."lca_release_publications"
    ADD CONSTRAINT "lca_release_publications_superseded_by_fkey" FOREIGN KEY ("superseded_by") REFERENCES "public"."lca_release_publications"("id") ON DELETE RESTRICT;
