CREATE OR REPLACE FUNCTION "public"."cmd_lca_release_approve"("p_release_run_id" "uuid", "p_publish_plan_hash" "text", "p_expires_at" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_reason" "text" DEFAULT NULL::"text", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_lca_release_approve"("p_release_run_id" "uuid", "p_publish_plan_hash" "text", "p_expires_at" timestamp with time zone, "p_reason" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_lca_release_approve"("p_release_run_id" "uuid", "p_publish_plan_hash" "text", "p_expires_at" timestamp with time zone, "p_reason" "text", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_lca_release_approve"("p_release_run_id" "uuid", "p_publish_plan_hash" "text", "p_expires_at" timestamp with time zone, "p_reason" "text", "p_audit" "jsonb") TO "authenticated";
