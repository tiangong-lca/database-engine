CREATE OR REPLACE FUNCTION "public"."get_lca_release_run"("p_release_run_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."get_lca_release_run"("p_release_run_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."get_lca_release_run"("p_release_run_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."get_lca_release_run"("p_release_run_id" "uuid") TO "anon";

GRANT ALL ON FUNCTION "public"."get_lca_release_run"("p_release_run_id" "uuid") TO "authenticated";

GRANT ALL ON FUNCTION "public"."get_lca_release_run"("p_release_run_id" "uuid") TO "service_role";
