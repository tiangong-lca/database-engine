CREATE OR REPLACE FUNCTION "public"."get_lcia_scope_closure_check"("p_closure_check_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."get_lcia_scope_closure_check"("p_closure_check_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."get_lcia_scope_closure_check"("p_closure_check_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."get_lcia_scope_closure_check"("p_closure_check_id" "uuid") TO "authenticated";
