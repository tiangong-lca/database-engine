...
do $verify_portal_facet_backfill_40_7f$
begin
  if exists (
    select 1
    from private.portal_catalog_search_rows_v1 as projection
    ...
    where projection.id >= '40000000-0000-0000-0000-000000000000'::uuid
    and projection.id < '80000000-0000-0000-0000-000000000000'::uuid
      and (
        facet.id is null
    ...
    where facet.id >= '40000000-0000-0000-0000-000000000000'::uuid
...
$verify_portal_facet_backfill_40_7f$;
