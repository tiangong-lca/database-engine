CREATE OR REPLACE FUNCTION "public"."lcia_scope_closure_certificate_validity_guard"() RETURNS "trigger"
...
ALTER FUNCTION "public"."lcia_scope_closure_certificate_validity_guard"() OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lcia_scope_closure_certificate_validity_guard"() FROM PUBLIC;
