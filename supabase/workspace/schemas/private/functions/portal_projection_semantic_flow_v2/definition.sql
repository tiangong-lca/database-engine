CREATE OR REPLACE FUNCTION "private"."portal_projection_semantic_flow_v2"("p_query_embedding" "extensions"."vector", "p_filters" "jsonb") RETURNS TABLE("id" "uuid", "version" "text", "semantic_distance" double precision)
