CREATE OR REPLACE FUNCTION "public"."cmd_lca_release_unpublish"("p_publication_id" "uuid", "p_reason" "text", "p_audit" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_lca_release_unpublish"("p_publication_id" "uuid", "p_reason" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_lca_release_unpublish"("p_publication_id" "uuid", "p_reason" "text", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_lca_release_unpublish"("p_publication_id" "uuid", "p_reason" "text", "p_audit" "jsonb") TO "authenticated";
