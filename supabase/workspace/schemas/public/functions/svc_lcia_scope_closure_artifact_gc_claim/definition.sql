CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_claim"("p_limit" integer DEFAULT 100, "p_lease_seconds" integer DEFAULT 300) RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_claim"("p_limit" integer, "p_lease_seconds" integer) OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_claim"("p_limit" integer, "p_lease_seconds" integer) FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_claim"("p_limit" integer, "p_lease_seconds" integer) TO "service_role";
