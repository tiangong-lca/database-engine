CREATE OR REPLACE FUNCTION "public"."processes_derivative_rebuild_embedding_input"("p_process" "public"."processes") RETURNS "text"
...
ALTER FUNCTION "public"."processes_derivative_rebuild_embedding_input"("p_process" "public"."processes") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."processes_derivative_rebuild_embedding_input"("p_process" "public"."processes") FROM PUBLIC;
