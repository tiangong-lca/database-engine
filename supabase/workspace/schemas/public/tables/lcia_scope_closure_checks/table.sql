...
ALTER TABLE "public"."lcia_scope_closure_checks" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."lcia_scope_closure_checks"
...
ALTER TABLE ONLY "public"."lcia_scope_closure_checks"
    ADD CONSTRAINT "lcia_scope_closure_checks_closure_bundle_artifact_fkey" FOREIGN KEY ("closure_bundle_artifact_id") REFERENCES "public"."worker_job_artifacts"("id") ON DELETE RESTRICT NOT VALID;

ALTER TABLE ONLY "public"."lcia_scope_closure_checks"
    ADD CONSTRAINT "lcia_scope_closure_checks_report_artifact_id_fkey" FOREIGN KEY ("report_artifact_id") REFERENCES "public"."worker_job_artifacts"("id") ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."lcia_scope_closure_checks"
    ADD CONSTRAINT "lcia_scope_closure_checks_reused_from_check_id_fkey" FOREIGN KEY ("reused_from_check_id") REFERENCES "public"."lcia_scope_closure_checks"("id") ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."lcia_scope_closure_checks"
    ADD CONSTRAINT "lcia_scope_closure_checks_scan_execution_id_fkey" FOREIGN KEY ("scan_execution_id") REFERENCES "public"."lcia_scope_closure_scan_executions"("id") ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."lcia_scope_closure_checks"
    ADD CONSTRAINT "lcia_scope_closure_checks_worker_job_id_fkey" FOREIGN KEY ("worker_job_id") REFERENCES "public"."worker_jobs"("id") ON DELETE RESTRICT;

ALTER TABLE "public"."lcia_scope_closure_checks" ENABLE ROW LEVEL SECURITY;

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."lcia_scope_closure_checks" TO "service_role";
