...
lastReviewedNote: "Reviewed for Issue #582: direct Supabase OAuth MCP hosts use separate public clients with exact capability admission; DCR remains disabled and environment client IDs stay outside migrations."
related:
  - .docpact/config.yaml
