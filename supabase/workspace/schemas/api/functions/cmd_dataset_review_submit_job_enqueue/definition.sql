...
declare
  ...
  v_existing private.dataset_review_submit_requests%rowtype;
...
begin
  ...
  if v_existing.id is not null then
    return jsonb_build_object(
      'ok', true,
      'data', private.cmd_dataset_review_submit_job_payload(v_existing)
    );
  end if;
  ...
  if v_job_status = 'blocked' then
    ...
    v_last_error_details := private.worker_job_payload(v_worker_job, false);
...
ALTER FUNCTION "api"."cmd_dataset_review_submit_job_enqueue"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_audit" "jsonb") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_enqueue"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_audit" "jsonb") FROM PUBLIC;

GRANT ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_enqueue"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_audit" "jsonb") TO "api_internal_executor";

GRANT ALL ON FUNCTION "api"."cmd_dataset_review_submit_job_enqueue"("p_table" "text", "p_id" "uuid", "p_version" "text", "p_revision_checksum" "text", "p_policy_profile" "text", "p_report_schema_version" "text", "p_audit" "jsonb") TO "authenticated";
