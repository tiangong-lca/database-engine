...
lastReviewedNote: "Reviewed for Issue #316: staged write-set validation now includes the shared fixture, 0/1/500/501/596/1500+ pgTAP matrix, bounded-request timing evidence, SQL/REST shape equivalence, and concurrent register/seal proof."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
