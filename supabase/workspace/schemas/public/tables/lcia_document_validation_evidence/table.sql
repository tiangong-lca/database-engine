...
ALTER TABLE "public"."lcia_document_validation_evidence" OWNER TO "postgres";

ALTER TABLE ONLY "public"."lcia_document_validation_evidence"
...
ALTER TABLE ONLY "public"."lcia_document_validation_evidence"
    ADD CONSTRAINT "lcia_document_validation_evidence_source_worker_job_id_fkey" FOREIGN KEY ("source_worker_job_id") REFERENCES "public"."worker_jobs"("id") ON DELETE SET NULL;

ALTER TABLE "public"."lcia_document_validation_evidence" ENABLE ROW LEVEL SECURITY;

GRANT ALL ON TABLE "public"."lcia_document_validation_evidence" TO "service_role";
