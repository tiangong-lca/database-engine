...
lastReviewedNote: "Reviewed for Issue #340 hosted closure: the REST contract supports legacy JWT keys and new opaque keys, including disposable secret-key cleanup evidence."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
