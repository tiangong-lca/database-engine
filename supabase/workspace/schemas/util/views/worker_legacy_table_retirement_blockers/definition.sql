CREATE OR REPLACE VIEW "util"."worker_legacy_table_retirement_blockers" WITH ("security_invoker"='true') AS
...
ALTER VIEW "util"."worker_legacy_table_retirement_blockers" OWNER TO "postgres";
