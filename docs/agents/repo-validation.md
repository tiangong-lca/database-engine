...
lastReviewedNote: "Reviewed for Issue #310 Contract cleanup: add explicit absence proof for extracted_text, legacy embedding flags/timestamps, rule-based projection helpers, and two-weight Hybrid compatibility while retaining extracted_md/embedding_ft plan evidence."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
