CREATE OR REPLACE FUNCTION "public"."cmd_dataset_alias_execution_read"("p_request_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."cmd_dataset_alias_execution_read"("p_request_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."cmd_dataset_alias_execution_read"("p_request_id" "uuid") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."cmd_dataset_alias_execution_read"("p_request_id" "uuid") TO "authenticated";
