CREATE OR REPLACE FUNCTION "private"."portal_projection_semantic_flow_cn1"("p_query_embedding" "extensions"."vector") RETURNS TABLE("id" "uuid", "version" "text", "semantic_distance" double precision)
...
ALTER FUNCTION "private"."portal_projection_semantic_flow_cn1"("p_query_embedding" "extensions"."vector") OWNER TO "api_internal_executor";

REVOKE ALL ON FUNCTION "private"."portal_projection_semantic_flow_cn1"("p_query_embedding" "extensions"."vector") FROM PUBLIC;
