CREATE OR REPLACE FUNCTION "private"."catalog_portal_process_keyword_keys_cn1"("p_query" "text", "p_cursor_rank" "text", "p_cursor_id" "uuid", "p_cursor_version" "text", "p_limit" integer) RETURNS TABLE("id" "uuid", "version" "text", "score" numeric)
...
REVOKE ALL ON FUNCTION "private"."catalog_portal_process_keyword_keys_cn1"("p_query" "text", "p_cursor_rank" "text", "p_cursor_id" "uuid", "p_cursor_version" "text", "p_limit" integer) FROM PUBLIC;
