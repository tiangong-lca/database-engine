CREATE OR REPLACE FUNCTION "public"."lcia_scope_closure_artifact_write_set_json"("p_write_set_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."lcia_scope_closure_artifact_write_set_json"("p_write_set_id" "uuid") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."lcia_scope_closure_artifact_write_set_json"("p_write_set_id" "uuid") FROM PUBLIC;
