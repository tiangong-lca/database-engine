...
lastReviewedNote: "Reviewed for Issue #323: the static-SQL notification latest-event migration does not change result GC runtime, rollout, deletion authority, or physical qualification."
related:
  - ../../AGENTS.md
  - ./repo-validation.md
