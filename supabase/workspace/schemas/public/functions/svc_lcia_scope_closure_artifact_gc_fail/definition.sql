CREATE OR REPLACE FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_fail"("p_artifact_id" "uuid", "p_claim_token" "uuid", "p_error" "text") RETURNS "jsonb"
...
ALTER FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_fail"("p_artifact_id" "uuid", "p_claim_token" "uuid", "p_error" "text") OWNER TO "postgres";

REVOKE ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_fail"("p_artifact_id" "uuid", "p_claim_token" "uuid", "p_error" "text") FROM PUBLIC;

GRANT ALL ON FUNCTION "public"."svc_lcia_scope_closure_artifact_gc_fail"("p_artifact_id" "uuid", "p_claim_token" "uuid", "p_error" "text") TO "service_role";
