CREATE OR REPLACE FUNCTION "api"."qry_notification_get_my_team_items"("p_days" integer DEFAULT 3) RETURNS TABLE("team_id" "uuid", "user_id" "uuid", "role" "text", "team_title" "jsonb", "modified_at" timestamp with time zone)
